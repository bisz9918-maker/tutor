...
from src.core.explanation_renderer import HTMLRenderer
from src.utils.utils import _print_response, _extract_code, extract_xml, parse_scene_outline_tokens
...
class ExplanationGenerator:
    ...
    def __init__(self,
                 ...
                 use_diff_patch: bool = True):  # Default: True (use diff-patch)
...
if __name__ == "__main__":
    ...
    parser.add_argument('--no_diff_patch', action='store_true',
                       help='Disable diff-patch mode for scene2+; generate full HTML code for every scene (default: False)')
    ...
    explanation_generator = ExplanationGenerator(
        ...
        use_diff_patch=not args.no_diff_patch
    )
