...
def get_prompt_code_generation_diff(topic: str,
                                    description: str,
                                    scene_outline: str,
                                    scene_implementation: str,
                                    scene_number: int,
                                    ...
                                    additional_context: Union[str, List[str]] = None) -> str:
    """
    Generate a diff-based prompt for scene2+ code generation.
    The model outputs only the changes relative to Scene 1's code.
    ...
    Args:
        ...
        scene_outline (str): The scene outline.
        scene_implementation (str): The detailed scene implementation.
        scene_number (int): The scene number (must be >= 2).
        scene1_code (str): The successfully rendered Scene 1 source code.
        additional_context (Union[str, List[str]]): Additional context to include.
    Returns:
        str: The formatted diff prompt.
    """
    prompt = _prompt_code_generation_diff.format(
        description=description,
        scene_outline=scene_outline,
        scene_implementation=scene_implementation,
        scene_number=scene_number,
